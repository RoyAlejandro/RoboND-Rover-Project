...
class RoverState():
    def __init__(self):
        ...
        # Created for helping in decision
        self.rock_dists = None # Distances of rock
        self.rock_angles = None # Angles of rock
        self.obst_dists = None # Distances of obstacle
        self.obst_angles = None # Angles of obstacle
        self.lastpos = None # Last position of the rover
        self.lastangle = 0 
        ...
        self.rock_task = 5 # can be rock or roll (yeah! :P )
        self.steerlimit = 15
